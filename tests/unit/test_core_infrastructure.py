...
class TestUnifiedConfig:
    ...
    def test_to_dict(self):
        """Test to_dict method."""
        config = UnifiedConfig(environment="development", debug=True, alpaca_api_key="test_key")
...
class TestIntegrationTests:
    ...
    def test_logging_with_exceptions(self, tmp_path):
        ...
        try:
            ...
            logger.exception(f"Configuration error occurred: {e}")
    ...
    def test_config_persistence_integration(self, tmp_path):
        ...
        unified_config = UnifiedConfig(environment="development", debug=True, alpaca_api_key="test_key")
