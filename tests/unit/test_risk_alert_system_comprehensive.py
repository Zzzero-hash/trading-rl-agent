...
from src.trading_rl_agent.risk.manager import RiskManager, RiskMetrics
...
class TestRiskAlertSystem:
    ...
    def test_risk_report_generation(self):
        ...
        # Add some test data
        self.alert_system.risk_history.append(
            RiskMetrics(
                portfolio_var=0.025,
                portfolio_cvar=0.035,
                max_drawdown=0.08,
...
class TestRegulatoryCompliance:
    ...
    def test_leverage_compliance_check(self):
        ...
        assert not self.alert_system._is_threshold_violated(compliant_metrics.leverage, compliant_threshold)
        assert self.alert_system._is_threshold_violated(non_compliant_metrics.leverage, compliant_threshold)
