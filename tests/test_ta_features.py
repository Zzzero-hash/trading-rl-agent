...
def test_compute_stochastic_constant():
    ...
    df_stoch = compute_stochastic(df.copy(), fastk_period=3, slowk_period=3, slowd_period=3)
...
def test_compute_stochastic_full():
    ...
    df_stoch = compute_stochastic(df.copy(), fastk_period=1, slowk_period=1, slowd_period=1)
