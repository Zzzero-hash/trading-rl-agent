...
from src.training.train_cnn_lstm import (
    CNNLSTMTrainer, TrainingConfig, SequenceDataset,
...
class TestSequenceDataset:
    ...
    def test_sequence_dataset_creation(self):
        ...
        dataset = SequenceDataset(features, targets, sequence_length=10, prediction_horizon=1)
    ...
    def test_sequence_dataset_multi_step_prediction(self):
        ...
        dataset = SequenceDataset(features, targets, sequence_length=5, prediction_horizon=3)
    ...
    def test_sequence_dataset_indexing(self):
        ...
        dataset = SequenceDataset(features, targets, sequence_length=3, prediction_horizon=1)
...
class TestCNNLSTMTrainer:
    ...
    def test_prepare_data_normalization(self):
        ...
        config_no_norm = TrainingConfig(normalize_features=False, include_sentiment=False)
    ...
    def test_create_data_loaders(self):
        ...
        train_loader, val_loader, test_loader = self.trainer.create_data_loaders(features, targets)
...
class TestConfigurationUtils:
    ...
    def test_create_example_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('src.training.train_cnn_lstm.create_example_config') as mock_create:
...
class TestErrorHandling:
    ...
    def test_insufficient_data(self):
        ...
        config = TrainingConfig(
            sequence_length=10,  # Longer than available data
            include_sentiment=False
        )
        trainer = CNNLSTMTrainer(config)
...
class TestSentimentIntegration:
    ...
    @patch('src.training.train_cnn_lstm.SentimentAnalyzer')
    def test_sentiment_feature_integration(self, mock_sentiment_analyzer, mock_sentiment_data):
