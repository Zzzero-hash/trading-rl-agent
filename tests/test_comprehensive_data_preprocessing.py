...
from src.data.features import (
    compute_ema, compute_macd, compute_atr, compute_bollinger_bands,
    compute_stochastic, compute_adx, compute_williams_r, compute_obv,
    detect_doji, detect_hammer, detect_engulfing, detect_shooting_star,
    generate_features
)
from src.data.synthetic import fetch_synthetic_data
from src.data.preprocessing import standardize_data, create_sequences
...
class TestFeatureEngineering:
    ...
    def test_feature_generation_pipeline(self):
        ...
        expected_features = ['ema_12', 'ema_26', 'macd', 'macd_signal', 'atr', 'bb_upper', 'bb_lower']
