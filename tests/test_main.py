...
class TestMainConfigLoading:
    ...
    def test_main_invalid_config_file(self, temp_dir):
        ...
        test_args = [
            'main.py',
            '--env-config', str(invalid_path),
            '--model-config', str(invalid_path),
            '--trainer-config', str(invalid_path)
        ]
    ...
    def test_main_missing_config_file(self):
        ...
        test_args = [
            'main.py',
            '--env-config', 'nonexistent.yaml',
            '--model-config', 'nonexistent.yaml',
            '--trainer-config', 'nonexistent.yaml'
        ]
