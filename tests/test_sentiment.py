...
from src.data.sentiment import (
    SentimentData, SentimentAnalyzer, SentimentConfig,
    NewsSentimentProvider, SocialSentimentProvider,
    get_sentiment_score, update_sentiment
)
...
class TestSentimentAnalyzer:
    ...
    def test_get_sentiment_features(self):
        ...
        expected_keys = [
            'sentiment_AAPL', 'sentiment_AAPL_abs',
            'sentiment_GOOGL', 'sentiment_GOOGL_abs'
        ]
