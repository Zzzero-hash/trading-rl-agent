...
class TestTradingEnvironmentComprehensive:
    ...
    def test_environment_initialization_comprehensive(self, comprehensive_market_data, environment_configs):
    ...
    def test_environment_reset_comprehensive(self, comprehensive_market_data, environment_configs):
    ...
    def test_environment_step_comprehensive(self, comprehensive_market_data, environment_configs, action_type):
    ...
    def test_environment_episode_completion(self, comprehensive_market_data, environment_configs):
        ...
        try:
            ...
            print(f"✅ Episode completed in {steps} steps with total reward: {total_reward:.4f}")
            
        except ImportError:
            pytest.skip("TradingEnv not available for testing")
    
    def test_environment_observation_consistency(self, comprehensive_market_data, environment_configs):
        ...
        try:
            ...
            print(f"✅ Observation consistency test passed with {len(observations)} observations")
    ...
    def test_environment_performance(self, comprehensive_market_data, memory_monitor):
        ...
        try:
            ...
            assert total_time < 30, f"Performance test failed: took {total_time:.2f} seconds"
            ...
            print(f"✅ Performance test passed: {total_time:.2f}s, {memory_increase:.2f}MB")
...
class TestEnvironmentStressTests:
    ...
    def test_memory_leak_prevention(self, comprehensive_market_data, memory_monitor):
        ...
        try:
            ...
            print(f"✅ Memory leak test passed - memory increase: {memory_increase:.2f} MB")
