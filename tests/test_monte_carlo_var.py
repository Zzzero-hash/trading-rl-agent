...
def var_config():
    ...
    return MonteCarloVaRConfig(n_simulations=1000, confidence_level=0.05, time_horizon=1, lookback_period=252)
...
class TestParallelVaRCalculator:
    ...
    def test_parallel_monte_carlo_var(self, var_config, sample_returns_data, sample_weights):
        ...
        with ParallelVaRCalculator(parallel_config) as parallel_calc:
            result = parallel_calc.parallel_monte_carlo_var(var_config, sample_returns_data, sample_weights)
    ...
    def test_parallel_stress_test(self, var_config, sample_returns_data, sample_weights):
        ...
        parallel_config = ParallelVaRConfig(use_multiprocessing=False, n_threads=2)

        with ParallelVaRCalculator(parallel_config) as parallel_calc:
            stress_results = parallel_calc.parallel_stress_test(var_config, sample_returns_data, sample_weights)
    ...
    def test_parallel_method_comparison(self, var_config, sample_returns_data, sample_weights):
        ...
        with ParallelVaRCalculator(parallel_config) as parallel_calc:
            method_results = parallel_calc.parallel_method_comparison(var_config, sample_returns_data, sample_weights)
...
class TestIntegration:
    ...
    def test_parallel_integration(self, var_config, sample_returns_data, sample_weights):
        ...
        with ParallelVaRCalculator(parallel_config) as parallel_calc:
            ...
            parallel_result = parallel_calc.parallel_monte_carlo_var(var_config, sample_returns_data, sample_weights)
