...
def test_sac_optimization_redirect():
    ...
    from src.optimization.rl_optimization import optimize_td3_hyperparams, optimize_sac_hyperparams
...
def test_yaml_config_files():
    ...
    if config_path.exists():
        ...
        assert "alpha_lr" in config, "Config should contain SAC-specific alpha_lr parameter"
