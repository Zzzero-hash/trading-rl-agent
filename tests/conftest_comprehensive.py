...
try:
    ...
    def generate_sample_price_data(symbol="TEST", days=30, start_price=100.0, volatility=0.01):
...
def sample_price_data():
    ...
    return generate_sample_price_data(symbol="TEST", days=100, start_price=100.0, volatility=0.02)
...
def noisy_data():
    ...
    df.loc[outlier_indices, 'close'] *= np.random.choice([0.1, 10.0], size=len(outlier_indices))
