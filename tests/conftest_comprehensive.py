...
def sample_csv_path(tmp_path):
    """
    Yield the path to a temporary CSV file containing synthetic numeric data generated by TestDataManager.
    
    The CSV file is created in a temporary directory, contains only numeric columns, and is cleaned up after the test completes.
    """
...
def sample_csv_path_session(tmp_path_factory):
    """
    Provides the path to a session-scoped CSV file containing synthetic numeric data generated by TestDataManager.
    
    Yields:
        str: The file path to the generated CSV file. The file is cleaned up after the session ends.
    """
    from tests.test_data_utils import TestDataManager
    import pandas as pd
