...
from trading_rl_agent.console import print_table, print_metrics_table, print_status_table
...
class TestCLIFunctional:
    ...
    def test_train_hybrid_functional(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = self.run_cli_command([
                "train", "hybrid",
                "--cnn-lstm-path", str(cnn_model_path),
                "--rl-path", str(rl_model_path),
                "--output", str(temp_path)
            ])
