...
class ComprehensiveTestRunner:
    ...
    def run_unit_tests(self, pattern: Optional[str] = None, coverage: bool = True) -> bool:
    ...
    def run_code_quality_checks(self) -> bool:
        ...
        checks = {
            "black": [sys.executable, "-m", "black", "--check", "--diff", "src/", "tests/"],
            "isort": [sys.executable, "-m", "isort", "--check-only", "--diff", "src/", "tests/"],
            "flake8": [sys.executable, "-m", "flake8", "src/", "tests/", "--max-line-length=100"],
        }
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Comprehensive test runner for trading RL agent")
    
    parser.add_argument("--suite", choices=["smoke", "unit", "integration", "performance", "memory", "e2e", "all"],
    ...
    parser.add_argument("--target-coverage", type=float, default=92.0, help="Coverage target percentage")
