...
async def demo_basic_monitoring():
    ...
    print(f"Risk Alert System initialized for portfolio: demo_portfolio")
    ...
    for i in range(10):
        ...
        print(f"Check {i+1}: VaR={metrics.portfolio_var:.3f}, "
...
async def demo_alert_thresholds():
    ...
    for scenario in test_scenarios:
        ...
        # Set metrics
        risk_manager.current_metrics = scenario['metrics']
        
        # Check thresholds
        await risk_alert_system._check_alert_thresholds(scenario['metrics'])
...
async def demo_circuit_breakers():
    ...
    for scenario in circuit_breaker_scenarios:
        ...
        await risk_alert_system._check_circuit_breakers(scenario['metrics'])
...
async def demo_escalation():
    ...
    for scenario in escalation_scenarios:
        ...
        test_alert = alert_manager.create_alert(
            ...
            severity=scenario['threshold'].severity,
            source="escalation_demo",
            alert_type="test_escalation"
        )
        
        # Trigger escalation
        await risk_alert_system._trigger_escalation(
            scenario['threshold'].escalation_level,
            test_alert
        )
        
        print(f"  Escalation level: {scenario['threshold'].escalation_level.value}")
...
async def demo_configuration_management():
    ...
    for threshold in risk_alert_system.alert_thresholds.values():
        print(f"  {threshold.metric_name}: {threshold.threshold_type} {threshold.threshold_value} "
