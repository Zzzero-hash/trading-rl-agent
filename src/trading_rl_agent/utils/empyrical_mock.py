...
def sharpe_ratio(returns: Union[np.ndarray, list], risk_free: float = 0.0) -> float:
    """
...
def sortino_ratio(returns: Union[np.ndarray, list], required_return: float = 0.0) -> float:
    """
...
def calmar_ratio(returns: Union[np.ndarray, list]) -> float:
    """
...
def value_at_risk(returns: Union[np.ndarray, list], cutoff: float = 0.05) -> float:
    """
...
def conditional_value_at_risk(returns: Union[np.ndarray, list], cutoff: float = 0.05) -> float:
    """
...
def beta(returns: Union[np.ndarray, list], benchmark_returns: Union[np.ndarray, list]) -> float:
    """
