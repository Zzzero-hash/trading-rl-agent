...
class AlpacaConfigModel(BaseModel):
    ...
    use_v2_api: bool = Field(
        default=True,
        description="Whether to use Alpaca V2 SDK"
    )
    ...
    data_feed: str = Field(
        default="iex",
        description="Data feed to use (iex, sip)"
    )
    ...
    log_trades: bool = Field(
        default=True,
        description="Whether to log all trades"
    )
    ...
    def from_environment(cls) -> AlpacaConfigModel:
        ...
        for field_name, env_var in cls.ENV_MAPPINGS.items():
            ...
            if env_value is not None:
                ...
                elif field_name in ['max_retries', 'websocket_timeout', 'order_timeout', 'cache_ttl', 'max_daily_trades']:
...
class AlpacaConfigManager:
    ...
    def __init__(self):
        self._config: Optional[AlpacaConfigModel] = None
        self._config_file: Optional[Path] = None
    
    def load_config(self, config_file: Optional[str] = None) -> AlpacaConfigModel:
        """
...
def get_alpaca_config(config_file: Optional[str] = None) -> AlpacaConfigModel:
    """
